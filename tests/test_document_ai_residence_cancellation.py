#!/usr/bin/env python3
"""
Test Document AI OCR on a residence cancellation document to show raw output
"""
...
def test_document_ai_residence_cancellation():
    """Test Document AI on a residence cancellation document and show raw OCR output"""
    
    # Test with a residence cancellation document
    doc_path = "data/dataset/residence_cancellation/100285_page_1.jpg"
    
    if not os.path.exists(doc_path):
        print(f"❌ Document not found: {doc_path}")
        return
    
    print(f"🔍 Testing Document AI on residence cancellation: {os.path.basename(doc_path)}")
    print("=" * 80)
...
if __name__ == "__main__":
    test_document_ai_residence_cancellation()
